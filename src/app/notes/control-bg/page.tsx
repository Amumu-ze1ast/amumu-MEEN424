  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-10 space-y-8">
        ...
        {/* 15. PDF DOWNLOAD */}
        <div className="glass rounded-2xl p-6 hover:-translate-y-1 hover:shadow-lg transition-all duration-300" style={cs(0.42)}>
          <div className="flex items-center gap-3 mb-3">
            <span className="text-2xl">📄</span>
            <h2 className="font-heading font-bold text-navy-500 text-lg">Session 2 Lecture Notes</h2>
          </div>
          <p className="text-sm text-navy-400 leading-relaxed mb-4">
            View or download the full PDF lecture notes for this session — includes all diagrams, derivations, and the glossary.
          </p>
          <div className="flex gap-3 flex-wrap">
            <button
            ...
            <a
              href="/MEEN424_Session2_Notes.pdf"
              download
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl
                         bg-gold-500 text-navy-500 font-semibold text-sm
                         hover:bg-gold-400 hover:-translate-y-0.5 hover:shadow-lg
                         transition-all duration-200"
            >
              <svg className="w-4 h-4" viewBox="0 0 16 16" fill="none">
          ...
          <div className="bg-white rounded-2xl overflow-hidden w-full max-w-4xl shadow-2xl flex flex-col"
            ...
            <div className="bg-navy-500 px-5 py-3 flex items-center gap-3 shrink-0">
              ...
              <div className="flex-1 min-w-0">
                <div className="font-heading font-bold text-white text-sm">Session 2 Lecture Notes</div>
                <div className="text-xs text-white/50 font-mono">MEEN 424 — Control System Background</div>
              </div>
              <a
                href="/MEEN424_Session2_Notes.pdf"
                download
            ...
            <div className="flex-1 bg-gray-100">
              <iframe
                src="/MEEN424_Session2_Notes.pdf"
                className="w-full h-full"
                title="MEEN 424 Session 2 Notes"
                style={{ border: 'none' }}
              />
            </div>
          </div>
